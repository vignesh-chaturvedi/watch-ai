...
const HomePage = (props: Props) => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-grow flex-1"></div>
  ...
  function userPromptRecord() {
    ...
    if (mediaRecorderRef.current?.state == "recording") {
      // Check if recording && then stop recording && save to downloads
  ...
  function toggleAutoRecord() {
    if (autoRecordEnabled) {
      ...
      toast("Autorecord disabled"); //Toast - to notify change
    } else {
      setAutoRecordEnabled(true);
      toast("Autorecord enabled"); //Toast - to notify change
    }
  }
